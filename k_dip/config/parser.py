...
from k_dip.config.crawler import crawler
...
from k_dip.util import classes_to_strings, parse_range_str, strings_to_classes
...
class ConfigParser:
    ...
    def common_options(fn):
        ...
        fn = click.option(
            ...
            type=str,
            default=None,
            help="LLM service to use - should be full import path, like k_dip.services.gemini.GoogleGeminiService",
        )(fn)
    ...
    def generate_config_dict(self) -> Dict[str, any]:
        ...
        for k, v in self.cli_options.items():
            ...
            match k:
                ...
                case "chart_desc":
                    config["chart_desc"] = True
                case "use_llm_ocr":
                    config["use_llm_ocr"] = True
                case _:
    ...
    def get_llm_service(self):
        ...
        if service_cls is None:
            #service_cls = "k_dip.services.gemini.GoogleGeminiService"
            service_cls = "k_dip.services.vintern.VinternService"
        return service_cls
